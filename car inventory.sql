...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2024 at 12:06 AM
...
CREATE DEFINER=`root`@`localhost` FUNCTION `total_car_type_in_inventory` (`cartype` VARCHAR(20)) RETURNS INT(11) BEGIN
DECLARE x INT;
SELECT COUNT(*) into x from Car C WHERE Car_Type=cartype AND  NOT EXISTS (SELECT * FROM Payment P WHERE P.VinNo = C.VinNo);
RETURN x;
END$$
...
(3, 120032, '3.6 L', 'Chrysler', 'Pacifica', 'Limited', '2021', 'Red', 'Black', 40000, 'New'),
...
(1, 130026, '6.4', 'jeep', 'Gladiator', 'limited', '2022', 'black', 'grey', 0, 'New'),
...
(1, 'Denis', 'Hoffman', '4468, abc drive', 'Clarkston', 'Michigan', 'S00999765431', '2001-11-07', 71200, 22),
(2, 'Lee', 'Higgins', '3456, xyzzy Dr', 'Rochester Hills', 'Michigan', 'S00999765432', '1999-08-02', 31500, 25),
(5, 'Smita', 'Patel', '456, Doogwood,', 'Clarkston', 'Michigan', 'S00999765433', '2002-11-16', 35599, 21),
(6, 'Josh', 'Patel', '9976, Brooke Field', 'Rochester Hills', 'Michigan', 'S00999765434', '2002-11-03', 62500, 21),
(7, 'Sagar', 'Shah', '5467 DogWood dr', 'Clarkston', 'Michigan', 'S00999765435', '2002-08-05', 37500, 22),
(8, 'Dhruv', 'Patel', '4458 Cedar brook Dr', 'Rochester Hills', 'Michigan', 'S00999765436', '1987-06-13', 84000, 37),
(9, 'John', 'Pash', '3456 S Adams Creek', 'Auburn Hills', 'Michigan', 'S00999765437', '1989-11-01', 9000, 34),
(18, 'Harsh', 'Patel', '44572 Croock dr', 'Rochester Hills', 'Michigan', 'S00999765437', '1989-09-16', 0, 34);
...
(19, 2, 6, 120013, '2021-09-01', 12500),
(25, 1, 1, 120009, '2021-10-01', 17000),
(26, 1, 1, 120016, '2021-06-06', 21000),
(27, 1, 1, 120015, '2021-10-02', 14700),
(28, 1, 1, 120010, '2021-11-30', 18500),
(30, 1, 7, 120014, '2021-10-10', 22500),
(31, 1, 2, 120017, '2021-11-12', 31500),
(37, 1, 9, 120019, '2021-11-06', 9000),
(38, 1, 5, 120018, '2021-06-06', 17600),
(40, 2, 5, 120031, '2021-11-30', 17999);
